...
<div class="container">
  <div class="row">
     ...
     <h1 class="display-2 text-center mb-3"><i class="bi bi-file-pdf"></i> Pdf Book</h1> 
          <a href="tambah2.php"><button type="button" class="btn btn-success mb-3"><i class="bi bi-plus-circle"></i> Upload Pdf</button></a>
           <!-- Table -->
    ...
    <thead>
        ...
        <?php
            $query = mysqli_query($conn, "SELECT * FROM tb_pdf_book2"); 
        ?>
    <tbody>
         <?php $i = 1; ?>
        ...
        <tr>
            ...
            <td class="text-center"><h5><?php echo $data['judul_file_pdf']; ?></h5><a href="download2.php?filename=<?php echo $data['nama_file_pdf']?>">download</a></td>
        </tr>
           <?php $i++; ?>
          <?php endforeach; ?>
    </tbody>
