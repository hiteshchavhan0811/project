  ...
  if(isset($_POST['tambah'])){
      ...
      // cek apakah ekstensi nya berupa PDF
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
            ...
            echo "<script>alert('Error While Uploadiing File!');
...
<html lang="en">
  <head>
    ...
    <title> Medical History And Pathology Reports</title>
      <style>
      table, th, td {
  ...
  <body>
    <nav class="navbar navbar-dark bg-primary shadow mb-5">
      <div class="container-fluid">
       <a class="navbar-brand"><i class="bi bi-file-pdf"></i> Medical History And Pathology Reports</a>
       <a href="index.php"><button type="button" class="btn btn-success mb-3">Home</button></a>
      </div>
    </nav>
...
<div class="container">
  <div class="row">
      <div class="col">
     <h1 class="display-2 text-center mb-3"><i class="bi bi-file-pdf"></i> Medical History And Pathology Reports</h1> 
    ...
    <thead>
        <tr>
            ...
            <th class="text-center"> Medical History And Pathology Reports</th>
        </tr>
    </thead>
        <?php
...
$userrow = $database->query("select pemail from patient where pemail='$useremail'");



            $query = $conn->query("select * from tb_pdf_book where judul_file_pdf like '$useremail%'");
