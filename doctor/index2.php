  ...
  if(isset($_POST['tambah'])){
      ...
      // cek apakah ekstensi nya berupa PDF
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
            ...
            echo "<script>alert('Error While Uploading File!');
...
<div class="container">
  <div class="row">
     ...
     <h1 class="display-2 text-center mb-3"><i class="bi bi-file-pdf"></i> Medical History And Pathology Reports</h1> 
          <a href="tambah.php"><button type="button" class="btn btn-success mb-3"><i class="bi bi-plus-circle"></i> Upload Reports</button></a>
           <!-- Table -->
